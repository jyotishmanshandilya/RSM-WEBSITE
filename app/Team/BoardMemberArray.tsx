const executiveBoard = [
  {
    ...
    message:
      "Pratinav is a Medical Imagery and Trustworthy AI enthusiast. He is interested in mitigating issues related to trustworthiness of AI models in a post-hoc manner. He has experience in Generative AI, Uncertainty Quantification, NLP and AI for Social Good with multiple publications at various workshops of CVPR,ICLR,ACL and NeurIPS.",
    image: "Pratinav_Seth.jpg",
    link: `https://linktr.ee/ptnvs`,
  },
  {
...
const societyMembers = [
  ...
  },
  {
    ...
    members: ["Saksham Mamtani", "M.varun chickkannan", "Ujjwal Sharma"],
  },
  {
    domain: "Physics",
    members: ["Udeet Mittal", "Aarushi Dhanuka", "Manas Dave", "SG Siddhanth"],
  },
  {
    domain: "Mathematics",
    members: [
  ...
  },
  {
    ...
    members: ["Shruti", "Sana Shetty", "Ramit", "Santusti Gour"],
  },
];
